...
public interface IAccountManager {
	 ...
	 */
    int createAccount(String name, float initialBalance);
     ...
     */
    float deposit(int accountNbr, float amount) throws AccountNotFoundException;
     ...
     */
    float withdraw(int accountNbr, float amount) throws AccountNotFoundException, InsufficientFundsException;
