...
(defun pong-move-left ()
  "Move bat 2 up. This is called left for historical reasons, since in some pong implementations you move with left/right paddle."
  (interactive)
...
(defun pong-update-game (pong-buffer)
  "Main function for pong. It is called every pong-cycle-delay seconds and updates ball and bats positions.  It is responsible of collision detection and checks if a player scores."
...
(defun pong ()
  "Play pong and waste time. This is an implementation of the classical game pong. Move left and right bats and try to bounce the ball to your opponent. pong-mode keybindings:\\<pong-mode-map> \\{pong-mode-map}"
  (interactive)
