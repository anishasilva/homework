...
public class Driver
{
       public static void main(String[] args)
    {
        ...
        creditHoursInput = userInput.nextInt();

        System.out.println("Major: ");
        majorInput = userInput.next();
        ...
        Employee e =
                new StudentEmployee(firstNameInput, lastNameInput, idInput, rateInput, workedDays,
                                creditHoursInput, majorInput);
