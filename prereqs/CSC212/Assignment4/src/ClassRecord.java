public class ClassRecord
{
	...
	public ClassRecord(String fn, String ln)
	{
		firstName = fn;
		lastName = ln;
		totalHwGrade = -1;
	...
	// include code to ensure that fields hold only valid data.
	...
	//Overriding the toString method so that we can use println() with ClassRecord objects
