...
#endif
/* Tokens.  */
#define MINUS_LEX 258
#define PLUS_LEX 259
#define MOD_LEX 260
#define SLASH_LEX 261
#define STAR_LEX 262
#define CARET_LEX 263
#define NUMBER_LEX 264
#define STRING_LEX 265
#define END_PAREN_LEX 266
#define BEGIN_PAREN_LEX 267
...
{
      14,     0,    -1,    14,     4,    15,    -1,    14,     3,    15,
      -1,    15,    -1,    15,     7,    16,    -1,    15,     6,    16,
      -1,    16,    -1,    15,     5,    16,    -1,    17,     8,    16,
      -1,    17,    -1,    12,    14,    11,    -1,     9,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    55,    55,    59,    63,    68,    72,    76,    80,    85,
      89,    94,    98
};
#endif
...
{
  "$end", "error", "$undefined", "MINUS_LEX", "PLUS_LEX", "MOD_LEX",
  "SLASH_LEX", "STAR_LEX", "CARET_LEX", "NUMBER_LEX", "STRING_LEX",
  "END_PAREN_LEX", "BEGIN_PAREN_LEX", "$accept", "expression", "term",
  "factor", "var", 0
};
#endif
...
{
       0,    12,     0,     0,     4,     7,    10,     0,     1,     0,
       0,     0,     0,     0,     0,    11,     3,     2,     8,     6,
       5,     9
};
...
{
       9,    10,     8,     7,     1,     9,    10,     2,    15,    18,
      19,    20,    21,    11,    12,    13,    16,    17,    14
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     0,     2,     9,     3,     4,    12,    11,    11,
      12,    13,    14,     5,     6,     7,     9,    10,     8
};
...
{
       0,     9,    12,    14,    15,    16,    17,    14,     0,     3,
       4,     5,     6,     7,     8,    11,    15,    15,    16,    16,
      16,    16
};
...
#line 56 "calc.y"
    {
	answer = (yyval) = (yyvsp[(1) - (3)]) + (yyvsp[(3) - (3)]);
;}
    break;
